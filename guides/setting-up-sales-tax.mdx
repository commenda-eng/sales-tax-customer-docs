...
keywords: ["indirect tax setup", "tax compliance", "tax registration", "nexus"]
---
...
- Knowledge of where you have indirect tax nexus
...
3. **Locations** — add your business locations (these help determine nexus)
...
4. Commenda will sync your transaction data automatically.
