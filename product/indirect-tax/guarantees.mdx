...
- Incorrect registration threshold settings
...
- Customer decides not to collect tax in a jurisdiction where they've exceeded the registration threshold
...
- Maintain accurate registration threshold settings
