...
When a transaction is linked to a customer with a valid exemption certificate, the tax is automatically adjusted. Transactions with applied exemptions are flagged in your transaction list.
