...
| Status | Description |
|--------|-------------|
| **Pending** | Recipient is waiting for notification, or waiting for a previous signer to complete (when using signing order) |
| **Sent** | DocuSign has sent the email to the recipient |
| **Viewed** | Recipient has opened the document |
| **Signed** | Recipient has completed signing |
| **Canceled** | You or an agent canceled the signature request |
