...
### When a signature is declined or canceled

1. The task status updates to "Canceled"
2. All other pending signatures are voided
3. The reason for cancellation is recorded
