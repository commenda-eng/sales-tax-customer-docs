---
title: "Xero"
description: "Connect Xero to sync accounting data and automate sales tax calculations"
---

## Overview

The Xero integration connects your Xero account to Commenda for automatic transaction syncing and real-time sales tax calculation. Commenda pulls your invoices, credit notes, contacts, and items, then calculates and applies the correct sales tax on your Xero documents.
...
<Info>
Only accounts receivable invoices (`ACCREC`) and accounts receivable credit notes (`ACCRECCREDIT`) are processed for tax calculation.
</Info>
...
- Invoices with **paid**, **voided**, or **deleted** status are skipped for tax calculation
- Xero does not support shipping lines or shipping amounts on documents, so shipping tax is not calculated separately
- Tax codes are created dynamically in Xero as new tax rates are encountered
