...
Commenda integrates with 20+ accounting platforms, allowing you to automatically sync transaction data, invoices, contacts, and chart of accounts. Once connected, Commenda uses this data to calculate sales tax, generate financial reports, and keep your records up to date.
...
<Steps>
  ...
  <Step title="Open integrations">
    Look for the **Connect accounting software** option in your Sales Tax or entity settings. Select the accounting platform you want to connect.
  </Step>
