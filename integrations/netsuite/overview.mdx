...
The NetSuite integration connects your Oracle NetSuite account to Commenda for automatic transaction syncing and indirect tax calculation. Commenda pulls your invoices, contacts, items, and cash sales, then calculates and applies the correct indirect tax on your NetSuite documents.
