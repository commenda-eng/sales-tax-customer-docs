...
1. **Google returns ISO code** (e.g., "CA"): Looks up the full state name from the database
2. **Google returns full name** (e.g., "California"): Looks up the ISO code from the database
3. **Google returns local variant** (e.g., "Québec"): Looks up the ISO code from the database
