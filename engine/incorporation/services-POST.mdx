...
```json Example error response
{
  "statusCode": 400,
  "message": [
    "serviceType must be one of the supported affiliate public API services: US_CCORP_INCORPORATION, US_LLC_INCORPORATION, CA_CORP_INCORPORATION, INDIA_PVT_LTD_INCORPORATION, INDIA_LLP_INCORPORATION, UAE_INCORPORATION, UK_INCORPORATION, IE_INCORPORATION, SG_INCORPORATION"
  ],
  "error": "Bad Request"
}
```
