...
<Note>
The `postal_code` field is **optional** for EU countries (such as DE and FR), GB, and CA. If a postal code is provided for these countries, it is still validated against the country's regex pattern. For the US, postal code remains **required**.
</Note>
