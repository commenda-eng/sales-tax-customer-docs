...
| transaction_type| true | [Transaction Type](#transaction-type-code) | A code indicating the type of transaction (SALE or RETURN) | 
...
1. **Required Fields:**
   ...
   - `parent_invoice_id` is recommended but optional
