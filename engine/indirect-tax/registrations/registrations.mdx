...
A **registration** represents a seller's tax registration with a tax authority in a specific jurisdiction (state, city, county, district, country, or trade bloc). Commenda tracks these registrations at the corporation level to ensure accurate tax calculations and enable automated filing.
...
- Use the [Registration Input Options](/engine/indirect-tax/registrations/content/registration-input-options-POST) endpoint to discover which member state content IDs are available for a trade bloc registration
...
- **VAT** — Value Added Tax (used for EU and other international jurisdictions)
