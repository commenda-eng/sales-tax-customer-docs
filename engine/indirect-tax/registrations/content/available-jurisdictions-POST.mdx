...
| `jurisdictions[].state_or_province` | string \| null | State or province code. Null for country-level and tradebloc jurisdictions. |
...
```json 200
{
  "data": {
    "jurisdictions": [
      ...
      {
        "jurisdiction_id": "JUR_GB_COUNTRY_GB",
