...
<Columns cols={2}>
  ...
  <Card title="Company Name Checker" icon="magnifying-glass" href="/engine/company-name-checker/overview">
    Verify whether a proposed business name is available across US states before incorporating.
  </Card>
...
| Check if a company name is available | [Company Name Checker](/engine/company-name-checker/overview) |
...
### CommendaOS public API

The CommendaOS public API also uses an affiliate API key passed in the `x-api-key` header:
